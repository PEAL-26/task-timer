        ...
        < table className="flex-1 flex flex-col " >
            <thead>
                <tr className="flex bg-black-light rounded-md  mb-3 ">
                    ...
                    <th className="w-2/12 text-left border-l border-gray/20 py-3 px-4">Tempo</th>
                    <th className="w-2/12 text-left border-l border-gray/20 py-3 px-4">Data Conclusão</th>
                </tr>
            </thead>

            <tbody className="flex-grow bg-black-light rounded-md">
                {tarefas?.map(({ id, projecto, dataConclusao }) => (
                    <tr key={id} className='flex w-full border-b border-gray/20 hover:bg-black/10'>
                        ...
                        <td className="w-1/5 text-left border-l border-gray/20 py-2 px-4 flex items-center">{projecto ?? <span className='text-xs'>Nenhum</span>}</td>
                        <td className="w-2/12 text-left border-l border-gray/20 py-2 px-4 flex items-center">{<Temporizador tarefaId={id} />}</td>
                        <td className="w-2/12 text-left border-l border-gray/20 py-2 px-4 flex items-center">
                            {dataConclusao
                                ? <span className='text-xs'>{dataConclusao}</span>
                                : <a
